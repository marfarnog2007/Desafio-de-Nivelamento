...
2) calcular_area_circulo: Demonstra a capacidade do agente de aplicar fórmulas matemáticas específicas usando bibliotecas como math.
  ...
  ## Como rodar:
  Explique como instalar o Python, configurar a API Key no código e rodar o comando python agente.py. 


## Dificuldades e Aprendizados:
(Sugestão: Mencione que foi desafiador configurar o function calling manualmente sem usar o LangChain ).
